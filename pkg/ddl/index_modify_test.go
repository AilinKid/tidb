...
partition by range (a) (
	...
	tk.MustExec(`create hybrid index idx_hybrid on pt_create(b, c) parameter '{"fulltext":[{"columns":["b"]}],"inverted":{"columns":["c"]}}'`)
...
partition by range (a) (
	...
	tk.MustExec(`alter table pt_alter add hybrid index idx_hybrid_alter(b, c) parameter '{"fulltext":[{"columns":["b"]}],"inverted":{"columns":["c"]}}'`)

...
func TestCreateFulltextIndex(t *testing.T) {
	...
	tblInfo := &model.TableInfo{ID: 1, Name: pmodel.NewCIStr("t"), Columns: []*model.ColumnInfo{{ID: 1, Name: pmodel.NewCIStr("c"), FieldType: types.FieldType{}}}, Version: 1}
	indexInfo := &model.IndexInfo{ID: 2, Name: pmodel.NewCIStr("idx"), Columns: []*model.IndexColumn{{Offset: 0}}, Unique: true}
	schemaName := "testdb"
...
func TestModelPrimaryKeyToTiCIIndexInfo(t *testing.T) {
	tblInfo := &model.TableInfo{
		...
		Columns: []*model.ColumnInfo{{ID: 1, Name: pmodel.NewCIStr("c"), FieldType: types.FieldType{}}},
		Version: 1,
		Indices: []*model.IndexInfo{
			{ID: 2, Name: pmodel.NewCIStr("pk"), Columns: []*model.IndexColumn{{Offset: 0}}, Unique: true, Primary: true},
		},
	}

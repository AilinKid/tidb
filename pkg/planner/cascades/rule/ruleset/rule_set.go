...
// List return the specified operand rule list.
func (ors *OperandRules) List() ListRules {
	return ors.setList
}
...
var OperandApplyRulesMap = map[SetType][]rule.Rule{
	XFSetDeCorrelateApply: {
		...
		decorrelate_apply.NewXFPullUpCorrPredicateFromProj(),
		decorrelate_apply.NewXFPullUpCorrPredicateFromSel(),
		decorrelate_apply.NewXFPullUpCorrPredicateFromDS(),
		decorrelate_apply.NewXFPullUpCorrPredicateFromSort(),
		decorrelate_apply.NewXFPullUpCorrPredicateFromLimit(),
		decorrelate_apply.NewXFPullUpCorrPredicateFromMax1Row(),
		decorrelate_apply.NewXFPullUpCorrPredicateFromAgg1(),
		decorrelate_apply.NewXFPullUpCorrPredicateFromAgg2(),
	},
}
